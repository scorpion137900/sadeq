...
(function ($) {
  ...
  $(".anim-image-parallax").each(function () {
    ...
    $(this)
      .wrap('<div class="anim-image-parallax-wrap"></div>')
      .parent()
      .css({ overflow: "hidden" });
  ...
  ScrollTrigger.matchMedia({
    "(min-width: 768px)": function () {
      $(
        ".tt-grid.ttgr-layout-creative-1 .tt-grid-item:nth-of-type(6n+2), .tt-grid.ttgr-layout-creative-1 .tt-grid-item:nth-of-type(6n+4), .tt-grid.ttgr-layout-creative-2 .tt-grid-item:nth-of-type(4n+2), .tt-grid.ttgr-layout-creative-2 .tt-grid-item:nth-of-type(4n+3)"
      ).each(function () {
        var $this = $(this);
  ...
  // 		if ($("body").hasClass("tt-smooth-scroll")) {
  // 			var $scrollbar = Scrollbar.init(
  // 				document.getElementsByClassName("scroll-container")
  // 			);
  // 			gsap.to($scrollbar, {
  // 				duration: 2,
  ...
  $("#tt-contact-form").submit(function (event) {
    ...
    // If there are errors, display them in one alert
    if (errors.length > 0) {
    ...
    $.ajax({
      type: "POST",
      url: "mail.php", // Change to your mail.php path
      data: th.serialize(),
    })
      .done(function () {
...
window.addEventListener("DOMContentLoaded", function () {
  let brandSwiper = new Swiper(".brand-swiper-container", {
    ...
    slidesPerGroup: 7, // Adjusts the number of slides to move on each swipe
    breakpoints: {
      300: {
        slidesPerView: 1,
        slidesPerGroup: 1,
  ...
  let worksSwiper = new Swiper(".our-works-swiper", {
    // loop: true,
    slidesPerView: "auto",
    centeredSlides: true,
    slidesPerView: 1,
    spaceBetween: 20, // Adjust this value to control the space between slides
    navigation: {
    ...
    breakpoints: {
      ...
      640: {
        slidesPerView: 1.5, // Show one full slide and part of another
        spaceBetween: 50,
      },
      1200: {
        slidesPerView: 2,
